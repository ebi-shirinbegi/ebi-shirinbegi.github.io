...
const ExperienceCard = ({ experience }) => (
    <VerticalTimelineElement contentStyle={{ background: '#1d1836', color: '#fff' }}
      ...
      <div> 
        ...
        <p className="text-secondary text-[16px] font-semibold">{experience.date}</p>
      </div>
...
const Experience = () => {
  return (
    <>
      <motion.div variants={textVariant()} className="mt-32 sm:mt-40 md:mt-48"> {/* Updated from mt-20 */}
